...
# Project Structure 
  - src/interpreter.c   
  - bin/interpret.exe - main file,download and use in your project directory   
  - test - contains sample code for some algorithms   
...
# Plans for Future Versions   
  ...
  - Provide Data Structures such as Lists,Dictionary   
  - Provide Functions   
  - Provide optional static typing   
  # Run Instructions for Test Programs   
  ```bash
